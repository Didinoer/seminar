...
const SERVER_API_KEY =
	"A2Vt8qPwqlWUHu6APQ5j8NOArta2HlNGeGMV3Bls7ZQvFM2xus2of4D5MwowfnYb";
...
export async function getTicketsById(invoiceCode) {
	const response = await fetch(
		`${API_URL}api/tickets/detailtickets/${invoiceCode}`,
		{
			headers: {
				Accept: "application/json",
				"Content-Type": "application/json",
...
export async function getTicketsByIdTicket(idTicket) {
	const response = await fetch(
		`${API_URL}api/tickets/detailtickets3/${idTicket}`,
		{
			headers: {
				Accept: "application/json",
				"Content-Type": "application/json",
...
export async function getAllVoucher() {
	const response = await fetch(`${API_URL}api/vouchers/getall`, {
		headers: {
			Accept: "application/json",
			"Content-Type": "application/json",
			Authorization: bearerToken,
...
export async function getAllInvitationCode() {
	const response = await fetch(`${API_URL}api/invitationcode/getall`, {
		headers: {
			Accept: "application/json",
			"Content-Type": "application/json",
			Authorization: bearerToken,
