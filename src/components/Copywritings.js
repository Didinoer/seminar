        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell>Completed Order</TableCell>
              <TableCell>Expired Order</TableCell>
            ...
            {data.length > 0 ? (
              data.map((row, idx) => (
                <TableRow key={row.id}>
                  ...
                  <TableCell>{row.new_order_template}</TableCell>
                  <TableCell>{row.completed_order_template}</TableCell>
                  <TableCell>{row.expired_order_template}</TableCell>
                  <TableCell>
                    <Button
                      variant="outlined"
                      color="success"
